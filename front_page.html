...
<html>
    ...
    <body style="background-color:#1b1b1b;overflow-x:hidden;overflow-y:hidden;">
        <div class="front_page" style="display:flex;justify-content:space-between;">
            <div class="sidebar" style="background-color:#1b1b1b;width:300px;height:100%;">
                ...
                <br><br><br>
                <div class="bar">
                <a href="Add_task.html" style="text-decoration:none;">
                ...
                <div class="bar">
                    <a href="Today.html" style="text-decoration:none;">
                        <button style="display:flex;">
                ...
                <div class="bar">
                    <a href="Upcoming.html" style="text-decoration:none;">
                        <button style="display:flex;">
                ...
                <div class="bar">
                    <a href="Filters.html" style="text-decoration:none;">
                        <button style="display:flex;">
                            ...
                            <p style="margin-top:0px;font-size:15px;"> Filters and Label </p>
                        </button>
                    </a>
                </div>
                <br><br>
            ...
            <div class="main" style="background-color:#000;width:80%;height:100%;">
                    <h2 style="font-family:Tahoma;margin-top:90px;margin-left:90px;color:#ceff1a;">Today</h2>
                    <div class="bar" style="margin-left:75px;margin-top:30px;">
                        <a href="Add_task.html" style="text-decoration:none;">
                            <button style="display:flex;background-color:#000;border:none;">
                                <img src="Add_task.png" style="width:20px;height:20px;border-radius:50%;margin-right:10px;">
                                <p style="margin-top:0px;font-size:15px;"> Add task </p>
                            </button>
                        </a>
                    ...
                    <img style="margin-top:30px;margin-left:400px;width:300px;height:300px;" src="Fp.png">
                    <p style="margin-left:380px;font-weight:bold;color:#fff;font-family:Tahoma;">What do you need to get done today?</p>
                    <p style="margin-right:0px;color:lightgrey;text-align:center;font-family:Tahoma;font-size:15px;">By default, tasks added here will be due <br>today. Click + to add a task.</p>
