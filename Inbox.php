        ...
        <div class="front_page" style="display:flex;justify-content:space-between;">
            ...
            <br><br><br>
                ...
                if ($result && $result->num_rows > 0) {
                    ...
                    $_SESSION['task_entry'] = $task_entry;
                    
                    echo '<div id="task-table" style="background-color:#000;border-radius:10px;color:#fff;width:1000px;margin-top:60px;">';
                    echo '<form id="taskformm" action="update.php" method="post">';
                    echo '<table style="margin-left:90px;">';
                    foreach ($task_entry as $index => $task) {
                        echo '<tr>';
                        $checked = $task["completed"] ? 'checked' : '';
                        echo '<td style="width:700px;"><input type="checkbox" style="background-color:#1b1b1b;" name="completed_task[]" value="' . $index . '" ' . $checked . ' onchange="submitForm()">';
            ...
            <script>
                ...
                function submitForm() {
                    document.getElementById("taskformm").submit(); 
                }
                function validate(){
